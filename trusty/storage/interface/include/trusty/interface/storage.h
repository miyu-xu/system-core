 ...
 * @data: Zero if /data is known to not be checkpointing. Positive if there is an active checkpoint or if the system doesn't yet know whether checkpointing will be needed.
 */
