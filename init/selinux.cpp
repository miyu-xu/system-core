...
void SetupOverlays() {
    ...
    // with sufficient privileges to be able to perform these operations. Since this is a
    // debug device with verity disabled, there's no need to be fine tuned, we'll
    // use the su domain. We will call overlay_remounter which will do the unmounts/mounts.
